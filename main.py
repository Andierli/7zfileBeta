...
async def onmessage(bot:TelegramClient,ev: NewMessage.Event,loop,ret=False):
    ...
    if 'http' in text:
        ...
        if file:
            if file!='':
                ...
                await bot.edit_message(ev.chat,message,text='💢Ping@ dio error el Enlace🔗')
        else:
             await bot.edit_message(ev.chat,message,text='💢Ping@ dio error el Enlace🔗')
        return
    ...
    if '/up' in text:
        ...
        try:
            ...
            await bot.edit_message(ev.chat,message,text=f'🔗Creando Los Links...')
            ...
            await bot.send_file(ev.chat,txtsendname,
                                ...
                                thumb='thumb.png',
                                buttons=[Button.url('📯Andi9919','https://t.me/Andi9919')])
